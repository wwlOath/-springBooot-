$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'bioaitech/sysrole/list',
        datatype: "json",
        colModel: [			
	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.sysRole.roleId == null ? "bioaitech/sysrole/save" : "bioaitech/sysrole/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		del: function (event) {
            ...
            layer.confirm('确定要删除选中的记录？', {
               ...
               if(!lock) {
		            ...
		            $.ajax({
                        type: "POST",
                        url: baseURL + "bioaitech/sysrole/delete",
                        contentType: "application/json",
		...
		getInfo: function(roleId){
			$.get(baseURL + "bioaitech/sysrole/info/"+roleId, function(r){
