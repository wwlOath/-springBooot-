	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.sysLog.id == null ? "sys/syslog/save" : "sys/syslog/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "sys/syslog/info/"+id, function(r){
                vm.sysLog = r.sysLog;
            });
		},
