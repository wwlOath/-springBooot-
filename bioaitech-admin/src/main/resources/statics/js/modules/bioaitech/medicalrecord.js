$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'bioaitech/medicalrecord/list',
        datatype: "json",
        colModel: [			
	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.medicalRecord.id == null ? "bioaitech/medicalrecord/save" : "bioaitech/medicalrecord/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		del: function (event) {
            ...
            layer.confirm('确定要删除选中的记录？', {
               ...
               if(!lock) {
		            ...
		            $.ajax({
                        type: "POST",
                        url: baseURL + "bioaitech/medicalrecord/delete",
                        contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "bioaitech/medicalrecord/info/"+id, function(r){
