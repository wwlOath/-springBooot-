$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'bioaitech/sysdept/list',
        datatype: "json",
        colModel: [			
	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.sysDept.deptId == null ? "bioaitech/sysdept/save" : "bioaitech/sysdept/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		del: function (event) {
            ...
            layer.confirm('确定要删除选中的记录？', {
               ...
               if(!lock) {
		            ...
		            $.ajax({
                        type: "POST",
                        url: baseURL + "bioaitech/sysdept/delete",
                        contentType: "application/json",
		...
		getInfo: function(deptId){
			$.get(baseURL + "bioaitech/sysdept/info/"+deptId, function(r){
