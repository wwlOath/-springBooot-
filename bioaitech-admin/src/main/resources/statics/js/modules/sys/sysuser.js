	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.sysUser.userId == null ? "sys/sysuser/save" : "sys/sysuser/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		del: function (event) {
            ...
            layer.confirm('确定要删除选中的记录？', {
               ...
               if(!lock) {
		            ...
		            $.ajax({
                        type: "POST",
                        url: baseURL + "sys/sysuser/delete",
                        contentType: "application/json",
		...
		getInfo: function(userId){
			$.get(baseURL + "sys/sysuser/info/"+userId, function(r){
