$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'bioaitech/sysdict/list',
        datatype: "json",
        colModel: [			
	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.sysDict.id == null ? "bioaitech/sysdict/save" : "bioaitech/sysdict/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		del: function (event) {
            ...
            layer.confirm('确定要删除选中的记录？', {
               ...
               if(!lock) {
		            ...
		            $.ajax({
                        type: "POST",
                        url: baseURL + "bioaitech/sysdict/delete",
                        contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "bioaitech/sysdict/info/"+id, function(r){
